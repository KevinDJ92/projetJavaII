...
<%-- 				Numero Telephone <input type="text" name="telephoneInsert" value="<%=(utilisateur !=null ? utilisateur.getTel_num():"")%>"/> <br/>
 --%>				Adresse <input type="text" name="adresseInsert" value="<%=(utilisateur !=null ? utilisateur.getAdresse():"")%>"/> <br/>
<%-- 				Code Postal <input type="text" name="codePostalInsert" value="<%=(utilisateur !=null ? utilisateur.getCode_postal():"")%>"/> <br/>
...
<%-- 				Reponse Security  <input type="text" name="reponseSecurityInsert" value="<%=(utilisateur !=null ? utilisateur.getRep_secure_q():"")%>"/> <br/>
<%--				Photo De Profil <input type="text" name="photoDeProfilInsert" value="<%=(utilisateur !=null ? utilisateur.getPhoto_profil():"")%>"/> <br/>--%>				<br/>
